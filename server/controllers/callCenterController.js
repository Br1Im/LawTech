...
const STATUS_TRANSITIONS = {
  NEW: ['IN_PROGRESS', 'NO_ANSWER', 'CALL_BACK', 'INTERESTED', 'BOOKED', 'REJECTED', 'SPAM', 'DUPLICATE', 'NON_TARGET', 'CLOSED'],
  IN_PROGRESS: ['NO_ANSWER', 'CALL_BACK', 'INTERESTED', 'BOOKED', 'REJECTED', 'SPAM', 'DUPLICATE', 'NON_TARGET', 'CLOSED'],
  NO_ANSWER: ['CALL_BACK', 'IN_PROGRESS', 'INTERESTED', 'BOOKED', 'REJECTED', 'SPAM', 'DUPLICATE', 'NON_TARGET', 'CLOSED'],
  CALL_BACK: ['IN_PROGRESS', 'NO_ANSWER', 'INTERESTED', 'BOOKED', 'REJECTED', 'SPAM', 'DUPLICATE', 'NON_TARGET', 'CLOSED'],
  INTERESTED: ['BOOKED', 'CLOSED', 'REJECTED'],
  BOOKED: ['CLOSED'],
  REJECTED: [],
  SPAM: [],
  DUPLICATE: [],
