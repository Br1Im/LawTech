...
const STATUS_TRANSITIONS = {
  NEW: ['IN_PROGRESS', 'NO_ANSWER', 'CALL_BACK', 'INTERESTED', 'BOOKED', 'REJECTED', 'CLOSED'],
  IN_PROGRESS: ['NO_ANSWER', 'CALL_BACK', 'INTERESTED', 'BOOKED', 'REJECTED', 'CLOSED'],
  NO_ANSWER: ['CALL_BACK', 'IN_PROGRESS', 'INTERESTED', 'BOOKED', 'REJECTED', 'CLOSED'],
  CALL_BACK: ['IN_PROGRESS', 'NO_ANSWER', 'INTERESTED', 'BOOKED', 'REJECTED', 'CLOSED'],
